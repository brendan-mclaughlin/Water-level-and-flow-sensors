...
#define LCD_D5		B, 3 // Arduino 4 //maybe PD4
#define LCD_D6		B, 4 // Arduino 3 PD3 
#define LCD_D7		B, 5 // Arduino 2 PD2
#define LCD_RS		D, 7 // Arduino 12 PB4
#define LCD_RW		B, 0 // Arduino 10 PB2
#define LCD_EN		B, 1 // Arduino 11 PB3
//----------------------------------------------//
#endif
